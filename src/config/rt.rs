...
impl RtcServe {
    pub(super) fn new(
        ...
        Ok(Self {
            ...
            tls_key_path: absolute_path_if_some(opts.tls_key_path, "tls_key_path")?,
            tls_cert_path: absolute_path_if_some(opts.tls_cert_path, "tls_cert_path")?,
        })
    }
}
...
fn absolute_path_if_some(
    ...
    Ok(if let Some(path) = maybe_path {
